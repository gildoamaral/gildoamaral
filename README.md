...
- **💻 Front-end:** Typescript, React, Redux, React Router, Next.js;
- **🧠 Back-end:** Typescript, Node.js (Express), Java (Spring Boot);  
- **🗄️ Banco de Dados:** MySQL, PostgreSQL, MongoDB (via Prisma);  
- **☁️ Infraestrutura:** Railway, Vercel, AWS S3;
...
### [Confraria Vintage](https://github.com/gildoamaral/loja-confraria-vintage) | [acesso ao site](https://confraria-vintage-production.up.railway.app/)
